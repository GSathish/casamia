...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/tres/br-node/border-router.c</source>
      <commands EXPORT="discard">make border-router.wismote TARGET=wismote</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/tres/br-node/border-router.wismote</firmware>
    ...
    <motetype>
      ...
      <description>Casa Mia Node (wismote)</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/tres/casamia-node/casamia-test.c</source>
      <commands EXPORT="discard">make casamia-test.wismote TARGET=wismote</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/tres/casamia-node/casamia-test.wismote</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>86.27031492248325</x>
        <y>75.68914983499924</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>96.45512994393566</x>
        <y>69.54830548382941</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>95.93091152371385</x>
        <y>82.27932426064491</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>13.353212573182871 0.0 0.0 13.353212573182871 -1090.9858539153493 -903.693307230234</viewport>
    </plugin_config>
    <width>319</width>
    <z>5</z>
    <height>288</height>
